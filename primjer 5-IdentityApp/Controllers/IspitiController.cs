...
using primjer_5_IdentityApp.Data;
...
namespace primjer_5_IdentityApp.Controllers
{
    public class IspitiController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,predmet,Datm")] Ispit ispit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,predmet,Datm")] Ispit ispit)
        {
            if (id != ispit.Id)
            {
                return NotFound();
